...
ax.set_axis_off()
im = ax.pcolormesh(data["x"],data["y"],np.arcsinh(data["Bx"][:,:,0].transpose()),cmap='RdBu_r')
plt.show()
...
fig.subplots_adjust(left=0,right=1,bottom=0,top=1,hspace=0,wspace=0)
ax.set_axis_off()
im = ax.pcolormesh(data["x"],data["y"],np.arcsinh(data["By"][:,:,0].transpose()),cmap='RdBu_r')
plt.show()
...
#ax.set_xmargin(0)
#ax.set_ymargin(0)
im = ax.pcolormesh(data["x"],data["y"],np.arcsinh(data["Bz"][:,:,0].transpose()),cmap='RdBu_r')#,shading='auto')
#plt.colorbar(im)
...
fig.subplots_adjust(left=0,right=1,bottom=0,top=1,hspace=0,wspace=0)
ax.set_axis_off()
im = ax.pcolormesh(data["x"],data["z"],np.arcsinh(data["Bx"][:,127,:].transpose()),cmap='RdBu_r')
...
fig.subplots_adjust(left=0,right=1,bottom=0,top=1,hspace=0,wspace=0)
ax.set_axis_off()
im = ax.pcolormesh(data["x"],data["z"],np.arcsinh(data["By"][:,127,:].transpose()),cmap='RdBu_r')
plt.show()
...
fig.subplots_adjust(left=0,right=1,bottom=0,top=1,hspace=0,wspace=0)
ax.set_axis_off()
im = ax.pcolormesh(data["x"],data["z"],np.arcsinh(data["Bz"][:,127,:].transpose()),cmap='RdBu_r')
qv = ax.quiver(qx, qz, qvx, qvz)
plt.show()
...
cmap = cmp.get_cmap("RdBu_r")
colors = plt.cm.RdBu_r(norm(np.arcsinh(data["Bz"][:,:,0].transpose())))
fig = plt.figure()
ax = fig.add_subplot(projection='3d')
